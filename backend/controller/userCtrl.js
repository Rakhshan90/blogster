...
const generateVerificationTokenCtrl = expressAsyncHandler(async (req, res) => {
    ...
    try {
        ...
        //Build your message
        const resetURL = `If your were requested to verify your account, please verify your account within 10 mins, otherwise ignore this meassage <a href="https://blogster-seven.vercel.app/verify-account/${verificationToken}">Click to verify your account<a/>`;
            ...
            body: {
                ...
                action: {
                    ...
                    button: {
                        ...
                        link: `https://blogster-seven.vercel.app/verify-account/${verificationToken}`
                    }
                },
...
const forgotPasswordTokenCtrl = expressAsyncHandler(async (req, res) => {
    ...
    try {
        ...
        //build your message
        const resetURL = `If your were requested to reset your account, please reset your account within 10 mins, otherwise ignore this meassage <a href="https://blogster-seven.vercel.app/reset-password/${token}">Click to verify your account<a/>`;
        // const testAccount = await nodemailer.createTestAccount();
        const transporter = await nodemailer.createTransport({
            service: 'gmail',
            auth: {
            ...
            body: {
                ...
                action: {
                    ...
                    button: {
                        color: '#22BC66', // Optional action button color
                        text: 'Reset Password',
                        link: `https://blogster-seven.vercel.app/reset-password/${token}`
                    }
                },
                outro: 'Do not reply to this email, It is an auto-generated email'
            }
